...
from metric_modules.fields import OTHER_OUTPUT_FIELDS
...
def main() -> None:
    ...
    config["methods"] = {"custom": True, "leo": True, "quansyn": True, "neosca": False}
    config["output_fields"] = OTHER_OUTPUT_FIELDS
